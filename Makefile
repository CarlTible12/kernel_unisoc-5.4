...
# Use the system clang-12 toolchain (instead of the bundled proton-12 submodule).
CC		= clang-12
LD		= ld.lld-12
AR		= llvm-ar-12
NM		= llvm-nm-12
...
LLVM		= 1
LLVM_IAS	= 1
export CC LD AR NM OBJCOPY OBJDUMP READELF OBJSIZE STRIP HOSTCC HOSTCXX CROSS_COMPILE CROSS_COMPILE_ARM32 LLVM LLVM_IAS
